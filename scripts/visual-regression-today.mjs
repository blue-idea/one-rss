...
const DESIGN_HTML = resolve(ROOT, 'ui/今日/code.html');
const DESIGN_IMAGE = resolve(ARTIFACTS_DIR, 'today-design.png');
const ACTUAL_IMAGE = resolve(ARTIFACTS_DIR, 'today-actual.png');
const DIFF_IMAGE = resolve(ARTIFACTS_DIR, 'today-diff.png');
const EXPO_PORT = 4176;
const APP_URL = `http://127.0.0.1:${EXPO_PORT}/`;
