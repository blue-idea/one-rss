...
const DESIGN_HTML = resolve(ROOT, 'ui/书架/code.html');
const DESIGN_IMAGE = resolve(ARTIFACTS_DIR, 'shelf-design.png');
const ACTUAL_IMAGE = resolve(ARTIFACTS_DIR, 'shelf-actual.png');
const DIFF_IMAGE = resolve(ARTIFACTS_DIR, 'shelf-diff.png');
const EXPO_PORT = 4174;
const APP_URL = `http://127.0.0.1:${EXPO_PORT}/shelf`;
