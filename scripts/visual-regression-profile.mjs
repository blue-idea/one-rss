...
const DESIGN_HTML = resolve(ROOT, 'ui/个人设置/code.html');
const DESIGN_IMAGE = resolve(ARTIFACTS_DIR, 'profile-design.png');
const ACTUAL_IMAGE = resolve(ARTIFACTS_DIR, 'profile-actual.png');
const DIFF_IMAGE = resolve(ARTIFACTS_DIR, 'profile-diff.png');
const EXPO_PORT = 4175;
const APP_URL = `http://127.0.0.1:${EXPO_PORT}/profile`;
