...
export default function LanguageSettingsScreen() {
  ...
  const settingsType: SettingsType =
    (params.type as SettingsType) || "interface";
  const languages =
    settingsType === "interface" ? INTERFACE_LANGUAGES : TRANSLATION_LANGUAGES;
  const currentLanguage =
    settingsType === "interface" ? interfaceLanguage : translationLanguage;
